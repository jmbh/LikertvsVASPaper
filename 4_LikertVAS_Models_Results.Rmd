...
#LikVAS <- readRDS("Files/AggregateData_Fig1_Feb15_24_v2.RDS")

LikVAS <- readRDS("Files/AggData.RDS")

durations <- readRDS("Files/Duration.Rds")

NA_prop <- readRDS("Files/NA_prop.RDS")

data_post <- readRDS("Files/data_PostQuestions.RDS")
...
load("Files/mod_Mean_zib_noLiktoVAS_fit.Rdata")
load("Files/mod_SD_zib_noLiktoVAS_fit.Rdata")
load("Files/mod_CorLag0_beta_noLiktoVAS_fit.Rdata")
load("Files/mod_Skew_noLiktoVAS_fit.Rdata")
load("Files/mod_RMSSD_zib_noLiktoVAS_fit.Rdata")
load("Files/mod_AR_noLiktoVAS_fit.Rdata")
load("Files/mod_Modality_noLiktoVAS_fit.Rdata")
load("Files/mod_Mean_zib_fit.Rdata")

load("Files/Model_BSI_group_fixed_fit.Rdata")
load("Files/mod_IEB_noLiktoVAS_fit.Rdata")
load("Files/mod_Missings_zoib_noVAS2Lik_fit.Rdata")
load("Files/mod_duration_log_fit.Rdata")
load("Files/model_post_fit.Rdata")

load("Files/posterior_Variances.Rdata")

load("Files/Model_BSI_group_fixed_fit.Rdata")

#Fitted model objects with Lik2VAS mapping included
load("Files/mod_Mean_zib_fit.Rdata")
load("Files/mod_CorLag0_beta_fit.Rdata")
load("Files/mod_Skew_fit.Rdata")

##Couldn't upload this to github, too large - go down to Appendix figures -> Figure: pp Checks to create
# load("Files/pp_figs.Rdata")
# 
# pp_Mean <- pp_figs[[1]]
# pp_SD <- pp_figs[[2]]
...
#   mutate(Difference_VASLik = VAS - `NA`) %>%
...
```{r correlations.DASS_S_2}

load("Files/Model_DASS_S_group_fixed_fit.Rdata")
...
load("Files/Model_DASS_A_group_fixed_fit.Rdata")
...
```{r correlations.DASS_D_2}

load("Files/Model_DASS_D_group_fixed_fit.Rdata")
...
```{r correlations.BSI}
load("Files/Model_BSI_VAS2Lik_group_fixed_fit.Rdata")
...
load("Files/Model_DASS_S_VAS2Lik_group_fixed_fit.Rdata")
...
```{r correlations.DASS_A_2}

load("Files/Model_DASS_A_VAS2Lik_group_fixed_fit.Rdata")
...
load("Files/Model_DASS_D_VAS2Lik_group_fixed_fit.Rdata")
...
pp_check(mod_duration_log_fit, ndraws = 30)
